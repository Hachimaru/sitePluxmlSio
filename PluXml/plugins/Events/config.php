...
if(!empty($_POST)) {
	if (!empty($_POST['event-new']) AND !empty($_POST['date-new']))  {
...
<div class="new">
 ...
 <form action="parametres_plugin.php?p=Events" method="post">
        ...
        <p>
			...
			<textarea id="zone" name="myfield" class="ckeditor">
				<?php echo plxUtils::strCheck($plxPlugin->getParam("zone")) ?>
			</textarea>
