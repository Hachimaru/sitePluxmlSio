...
class Plugin extends plxPlugin {
    ...
    $this->addHook('Plugin', 'Plugin2'); //hook pour l'affichage manuel
    } 
    ...
    public function Plugin2() {
		echo plxUtils::strCheck($this->getParam("data"));
    ...
    $script = $this->getParam('script');
        ...
        if ($script == 'true') { echo'<scr	ipt src="http://code.jquery.com/jquery-2.1.3.min.js"></script>';}
